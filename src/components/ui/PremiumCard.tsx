...
export function PremiumCard({ 
  ...
  const baseStyles = 'relative overflow-hidden rounded-3xl border border-white/70 bg-[linear-gradient(145deg,#ffffff_0%,#f8fbff_48%,#eef4ff_100%)] p-8 shadow-[0_20px_55px_rgba(30,64,175,0.12)]'
